...
package com.ringtone.maker.Activities
...
class Activity_Editor : AppCompatActivity(), MarkerView.MarkerListener, com.ringtone.maker.SoundEditor.WaveformView.WaveformListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        StatusBarUtil.setTranslucent(Activity_Editor@this)
        ...
        object : Thread() {
            override fun run() {
                try {
                    ...
                    runOnUiThread {
                        Toast.makeText(this@Activity_Editor, "请尝试修改文件名。", Toast.LENGTH_LONG).show()
                        AlertDialog.Builder(this@Activity_Editor)
                                .setTitle("错误")
                                .setMessage("文件名包含非法字符，请改名后重试。")
