package com.example.soundmuseum.record;
...
import com.example.soundmuseum.UserCenterActivity;
...
public class RecordRecyclerAdapter extends RecyclerView.Adapter<RecordRecyclerAdapter.RecordViewHolder>
    ...
    private void likeOrNot(final int position){
        String url = "http://1.15.157.176/soundmuseum/web/index.php?r=sound/addlikes";
    ...
    private void collectOrNot(final int position){
        String url = "http://1.15.157.176/soundmuseum/web/index.php?r=sound/addcollect";
    ...
    */
    private void queryFollowAndGo(final String tartget_username, final String headpic_url){
        ...
        String url = "http://1.15.157.176/soundmuseum/web/index.php?r=sound/isfollow";
