...
public class RecordFragment extends Fragment {
    ...
    // 各个页面对应的api
    String apis[] = {
            "http://1.15.157.176//soundmuseum/web/index.php?r=sound/randrecord",
            "http://1.15.157.176/soundmuseum/web/index.php?r=sound/hotrecord",
            "http://1.15.157.176/soundmuseum/web/index.php?r=sound/searchsound"
    };
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if(jsonObject.get("code").getAsInt() == 1){
                    ...
                    for(JsonElement record : data){
                        ...
                        String headPic = null;
                        if(!single_record.get("headPic").isJsonNull() || single_record.get("headPic") != null){
