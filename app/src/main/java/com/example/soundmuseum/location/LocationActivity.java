package com.example.soundmuseum.location;
...
public class LocationActivity extends Activity implements AdapterView.OnItemClickListener, OnGetGeoCoderResultListener, BaiduMap.OnMapStatusChangeListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fl_search:  //查找
                ...
                search_intent.putExtra("current_city", current_city == null ? "北京市" : current_city);
                startActivityForResult(search_intent, REQUEST_CODE);
                break;
            case R.id.tv_send:  //发送
                Intent intent = new Intent();
                intent.putExtra("address", mLocationValue);
                intent.putExtra("Lat", selected_latlng.latitude);
                intent.putExtra("Lng", selected_latlng.longitude);
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            //datas.addAll(location.getPoiList());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        selected_latlng = info.getLocation();
    ...
    public void onGetGeoCodeResult(GeoCodeResult result) {
        ...
        //Log.d("GeoCode", "onGetGeoCodeResult");
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            if(result == null){
                Log.d("GeoCode", "onGetReverseGeoCodeResult-result-null");
                return;
            }

            if(result.error != SearchResult.ERRORNO.NO_ERROR){
                Log.d("GeoCode", "ERROR: " + result.error);
            }
        ...
        selected_latlng = result.getLocation();
        datas.clear();
        ...
        if(result.getPoiList() == null) {
            Log.d("GeoCode", "poi-list is null");
        }
