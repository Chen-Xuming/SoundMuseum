...
import com.example.soundmuseum.account.AccountActivity;
import com.example.soundmuseum.record.RecordActivity;
...
public class MyCenterActivity extends AppCompatActivity {
    ...
    private void upLoadFile(final String uri){
        ...
        Request request = new Request.Builder()
                .url("http://1.15.157.176/soundmuseum/web/index.php?r=sound/uploadprofile")
                .post(requestBody)
                .build();
    ...
    private void sendIcon(final String response_url, final String local_uri){
        String api = "http://1.15.157.176/soundmuseum/web/index.php?r=sound/changeprofile";

        String headPicUrl = "http://1.15.157.176/" + response_url;
