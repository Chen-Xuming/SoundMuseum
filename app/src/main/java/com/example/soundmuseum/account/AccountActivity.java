package com.example.soundmuseum.account;
...
public class AccountActivity extends AppCompatActivity {
    ...
    String apis[] = {
            "http://1.15.157.176/soundmuseum/web/index.php?r=sound/followlist",    //关注列表
            "http://1.15.157.176/soundmuseum/web/index.php?r=sound/fanslist"        //粉丝列表
    };
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if(jsonObject.get("code").getAsInt() == 1){
                    ...
                    for(JsonElement account : data){
                        ...
                        int is_follow = single_account.get("follow") != null ?
                                            single_account.get("follow").getAsInt() : 0;

                        //String headPic = single_account.get("headPic") == null ?
                        //        null : single_account.get("headPic").getAsString();

                        String headPic = single_account.get("headPic").isJsonNull() ?
                                            null : single_account.get("headPic").getAsString();
